...
readonly MUGEN_INSTALLER_URL="https://github.com/SupremePi/lutris-Installer/raw/main/lutris-installer-solo.sh"
...
install() {
    ...
    sudo chmod +x /tmp/lutris-installer-solo.sh 2>/dev/null
    /tmp/lutris-installer-solo.sh
    sudo rm /tmp/lutris-installer-solo.sh 2>/dev/null
    clear
    exit 1
}
